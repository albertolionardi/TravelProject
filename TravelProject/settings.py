...
SECRET_KEY = 'django-insecure-&4(&v0-+bp#kkbv=%-dn90zc0y8gg5qqmf135ca3440bk6610@'
...
MIDDLEWARE = [
    ...
    'TravelProject.settings.CrossOriginOpenerPolicyMiddleware',
    'django.middleware.common.CommonMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'TravelProject/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
